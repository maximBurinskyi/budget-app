...
// export default function BudgetCard({ name, amount, max, gray, onViewExpensesClick, onAddExpenseClick, hideButtons }) {
//     const classNames = [];
//     if (amount > max) {
...
//                 variant={getProgresBarVariant(amount, max)} 
//                 min={0}
//                 max={max}
//                 now={amount}
//                 /> }
...
//                      className='ms-auto' 
//                      onClick={onAddExpenseClick}>Add expenses</Button>
